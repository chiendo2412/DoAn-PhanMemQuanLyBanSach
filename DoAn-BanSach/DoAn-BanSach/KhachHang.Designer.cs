...
namespace DoAn_BanSach {
    ...
    public partial class KhachHang : global::System.Data.DataSet {
        ...
        public partial class KhachHangDataTable : global::System.Data.TypedTableBase<KhachHangRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public KhachHangRow AddKhachHangRow(string MaKH, string TenKH, string GioiTinh, string DiaChi, string SoDT, System.DateTime NgaySinh) {
...
namespace DoAn_BanSach.KhachHangTableAdapters {
    ...
    public partial class KhachHangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [KhachHang] WHERE (([MaKH] = @Original_MaKH) AND ([TenKH] = @Original_TenKH) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ([DiaChi] = @Original_DiaChi) AND ([SoDT] = @Original_SoDT) AND ([NgaySinh] = @Original_NgaySinh))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [KhachHang] ([MaKH], [TenKH], [GioiTinh], [DiaChi], [SoDT], [NgaySinh" +
                "]) VALUES (@MaKH, @TenKH, @GioiTinh, @DiaChi, @SoDT, @NgaySinh);\r\nSELECT MaKH, T" +
                "enKH, GioiTinh, DiaChi, SoDT, NgaySinh FROM KhachHang WHERE (MaKH = @MaKH)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [KhachHang] SET [MaKH] = @MaKH, [TenKH] = @TenKH, [GioiTinh] = @GioiTinh, [DiaChi] = @DiaChi, [SoDT] = @SoDT, [NgaySinh] = @NgaySinh WHERE (([MaKH] = @Original_MaKH) AND ([TenKH] = @Original_TenKH) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ([DiaChi] = @Original_DiaChi) AND ([SoDT] = @Original_SoDT) AND ([NgaySinh] = @Original_NgaySinh));
SELECT MaKH, TenKH, GioiTinh, DiaChi, SoDT, NgaySinh FROM KhachHang WHERE (MaKH = @MaKH)";
        ...
        public virtual int Delete(string Original_MaKH, string Original_TenKH, string Original_GioiTinh, string Original_DiaChi, string Original_SoDT, System.DateTime Original_NgaySinh) {
        ...
        public virtual int Insert(string MaKH, string TenKH, string GioiTinh, string DiaChi, string SoDT, System.DateTime NgaySinh) {
            if ((MaKH == null)) {
        ...
        public virtual int Update(string MaKH, string TenKH, string GioiTinh, string DiaChi, string SoDT, System.DateTime NgaySinh, string Original_MaKH, string Original_TenKH, string Original_GioiTinh, string Original_DiaChi, string Original_SoDT, System.DateTime Original_NgaySinh) {
            if ((MaKH == null)) {
                throw new global::System.ArgumentNullException("MaKH");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenKH, string GioiTinh, string DiaChi, string SoDT, System.DateTime NgaySinh, string Original_MaKH, string Original_TenKH, string Original_GioiTinh, string Original_DiaChi, string Original_SoDT, System.DateTime Original_NgaySinh) {
            return this.Update(Original_MaKH, TenKH, GioiTinh, DiaChi, SoDT, NgaySinh, Original_MaKH, Original_TenKH, Original_GioiTinh, Original_DiaChi, Original_SoDT, Original_NgaySinh);
        }
    }
